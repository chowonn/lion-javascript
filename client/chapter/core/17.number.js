...
let number = 90_127.53100032; //5보다 높으면 올리는거
...
// 난수
let random = Math.random() * 10; //랜덤은 괄호 안에 인수를 안받음 곱하는건 최대 10까지
console.log('random:',random);

// 여러 수 중, 최댓값
let max = Math.max(10, 100, 100, 153, 55555);
console.log('max:',max);

// 여러 수 중, 최솟값
let min = Math.min(10, -10000, 1 , -10);
console.log('Min:',min);
